...
namespace HmsPlugin
{
    public partial class HuaweiStore : IStore
    {
        ...
        {
            Debug.Log("UnityIapProvider - HuaweiStore GetInstance!");
        ...
        void LoadComsumableProducts()
        {
            ...
            Debug.Log("UnityIapProvider - LoadComsumableProducts: " + consumablesIDs.Count);
        ...
        void LoadNonComsumableProducts()
        {
            ...
            Debug.Log("UnityIapProvider - LoadNonComsumableProducts: " + nonConsumablesIDs.Count);
        ...
        {
            var subscriptionIDs = (from defenition in initProductDefinitions where defenition.type == ProductType.Subscription select defenition.storeSpecificId).ToList();
            Debug.Log("UnityIapProvider - LoadSubscribeProducts: " + subscriptionIDs.Count);
            if (subscriptionIDs.Count > 0)
            {
                CreateProductRequest(subscriptionIDs, HuaweiConstants.IAP.IapType.SUBSCRIPTION, ProductsLoaded);
            }
            else
            {
                ProductsLoaded();
        ...
        private void CreateProductRequest(List<string> consumablesIDs, HuaweiConstants.IAP.IapType type, System.Action onSuccess)
        {
            ...
            Debug.Log("UnityIapProvider - CreateProductRequest: priceType: " + productsDataRequest.PriceType);
            Debug.Log("UnityIapProvider - CreateProductRequest: ProductIds: " + productsDataRequest.ProductIds.Count);
        ...
        {
            Debug.Log("UnityIapProvider - GetProductsFailure: " + exception.WrappedCauseMessage);
            Debug.Log("UnityIapProvider - GetProductsFailure: " + exception.WrappedExceptionMessage);
            this.storeEvents.OnSetupFailed(InitializationFailureReason.PurchasingUnavailable);
        }
